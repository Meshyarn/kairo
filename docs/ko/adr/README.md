...
- ADR-091: 에이전트 도구 채택 실패 분석 및 개선(기본값 balanced, evidence floor, nextCalls 승격, 레거시 도구명 정리; Phase 1–2 구현) → `docs/adr/ADR-091-agent-tool-adoption-failure-analysis-and-remediation.md`
...
- ADR-090: 8-step adoption/UX/docs drift 로드맵(WP1–WP8) → `docs/adr/ADR-090-8-step-roadmap-ux-doc-quality.md`
- ADR-091: 에이전트 도구 채택 실패 분석 및 개선 → `docs/adr/ADR-091-agent-tool-adoption-failure-analysis-and-remediation.md`
