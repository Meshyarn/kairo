...
function usage(): void {
    console.log(`kairo markdown wasm builder

Usage:
  kairo-build-markdown-wasm --source <localPath> [--out <dir>] [--root <projectRoot>] [--force]
...
function main(): void {
    ...
    console.log(`You can also set KAIRO_WASM_DIR=${outDir} if needed.`);
}
