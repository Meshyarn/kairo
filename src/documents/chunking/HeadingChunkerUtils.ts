...
export const resolveTokenOptions = (
...
export const findLineForByte = (byteOffset: number, lineOffsets: number[]): number => {
...
export const splitStructuralSegments = (
    lines: string[],
    startLine: number,
    endLine: number,
    options: DocumentOutlineOptions
...
export const splitFixedSegments = (
    lines: string[],
    startLine: number,
    endLine: number,
    options: DocumentOutlineOptions
...
export const splitSegmentsByMaxChars = (
    segments: Array<{ startLine: number; endLine: number; text: string }>,
    maxChars: number
): Array<{ startLine: number; endLine: number; text: string }> => {
...
export const splitRangeByMaxChars = (
    lines: string[],
    startLine: number,
    endLine: number,
    maxChars: number
...
export const mergeSmallSegments = (
    segments: Array<{ startLine: number; endLine: number; text: string }>,
    minChars: number,
    maxChars?: number
): Array<{ startLine: number; endLine: number; text: string }> => {
...
export const makeSegment = (lines: string[], startLine: number, endLine: number) => {
    return {
        startLine,
        endLine,
...
export const findFenceEnd = (lines: string[], startLine: number, endLine: number): number | null => {
...
export const isListLine = (line: string): boolean => {
...
export const computeEndByte = (endLine: number, lines: string[], offsets: number[]): number => {
