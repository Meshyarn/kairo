...
import { ChangePillar } from './pillars/change/ChangePillar.js';
import { NavigatePillar } from './pillars/NavigatePillar.js';
import { ReadPillar } from './pillars/ReadPillar.js';
import { WritePillar } from './pillars/WritePillar.js';
...
export class OrchestrationEngine {
  ...
  constructor(
    ...
    if (!FeatureFlags.isEnabled(FeatureFlags.PILLAR_DECOMPOSITION_ENABLED)) {
      console.warn('[OrchestrationEngine] Pillar decomposition disabled; using current modular pillars.');
    }
  }
