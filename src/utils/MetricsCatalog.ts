...
export const METRICS_CATALOG: MetricSpec[] = [
    ...
    { name: "symbolic_solver.used", type: "counter", unit: "count", level: "detailed", description: "symbolic solver invocations" },
    { name: "symbolic_solver.diagnostics", type: "counter", unit: "count", level: "detailed", description: "symbolic solver diagnostics emitted" },
    { name: "symbolic_solver.rule_only_missed", type: "counter", unit: "count", level: "detailed", description: "rule-only missed diagnostics compared to solver" },
    { name: "symbolic_solver.solver_only_missed", type: "counter", unit: "count", level: "detailed", description: "solver missed diagnostics compared to rule-only" },
    { name: "symbolic_solver.duration_ms", type: "histogram", unit: "ms", level: "detailed", description: "symbolic solver latency" },
