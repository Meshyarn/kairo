...
const DEFAULT_MODE = normalizeMode(process.env.KAIRO_METRICS_MODE);
const DEFAULT_MAX_SAMPLES = normalizeMaxSamples(process.env.KAIRO_METRICS_HIST_MAX_SAMPLES);
